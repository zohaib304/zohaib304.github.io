...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    let material = new THREE.ShaderMaterial({
        uniforms: {
            u_bg: { type: 'v3', value: rgb(30, 10, 70) },
            u_bgMain: { type: 'v3', value: rgb(30, 10, 70) },
            u_color1: { type: 'v3', value: rgb(240, 120, 30) },
            u_color2: { type: 'v3', value: rgb(240, 120, 30) },
    ...
    const animate = function () {
        ...
        // Increase t and j by a certain value every frame
        j += 0.01;
        t += 0.05;
    };
